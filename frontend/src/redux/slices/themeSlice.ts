...
const themeSlice = createSlice({
    ...
    reducers: {
        ...
        reset: (state) => {
            state.auth = initialThemeState.auth;
            state.user = initialThemeState.user;
            state.value = initialThemeState.value;
        }
    }
})

export default themeSlice.reducer;
export const { changeTheme, changeAuth, updateUser, updateUserCodes, filterCodes, reset } = themeSlice.actions;